...
function InstagramFeed() {
  ...
  return (
    <>
      <div className="mx-auto sm:w-9/12 my-8 py-6 rounded-lg bg-rosa-pastel shadow-md shadow-grafito-claro/60">
        <Swiper
          navigation={true}
                ...
                <div className="flex justify-center items-center">
                  ...
                  >
                    <img
                      ...
                      src={value.media_url}
                    />
                    <p className="sm:px-12 textOverflow text-justify mt-3 sm:mt-0 text-[#303030] font-medium mx-2 max-h-1/3 sm:max-h-96 w-full inline-block text-ellipsis ...  ">
                      {value.caption}
                    </p>
                  </a>
                </div>
